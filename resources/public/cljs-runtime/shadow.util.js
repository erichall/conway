...
var G__31941 = (i__4790__auto___31939 + (1));
i__4790__auto___31939 = G__31941;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq31821){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq31821));
}));
...
var len__4789__auto___31956 = arguments.length;
var i__4790__auto___31957 = (0);
while(true){
if((i__4790__auto___31957 < len__4789__auto___31956)){
args_arr__4810__auto__.push((arguments[i__4790__auto___31957]));

var G__31962 = (i__4790__auto___31957 + (1));
i__4790__auto___31957 = G__31962;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq31857){
...
var G__31860 = cljs.core.first(seq31857__$2);
var seq31857__$3 = cljs.core.next(seq31857__$2);
var G__31861 = cljs.core.first(seq31857__$3);
var seq31857__$4 = cljs.core.next(seq31857__$3);
var G__31862 = cljs.core.first(seq31857__$4);
var seq31857__$5 = cljs.core.next(seq31857__$4);
var G__31863 = cljs.core.first(seq31857__$5);
var seq31857__$6 = cljs.core.next(seq31857__$5);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31858,G__31859,G__31860,G__31861,G__31862,G__31863,seq31857__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__31910){
var vec__31913 = p__31910;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31913,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31913,(1),null);
