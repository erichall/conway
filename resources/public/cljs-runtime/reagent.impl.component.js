...
if((i < len)){
var k = (ks[i]);
var G__36451 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36452 = (i + (1));
m = G__36451;
i = G__36452;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36187 = p.children;
return module$node_modules$react$index.Children.toArray(G__36187);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36207 = c;
var G__36207__$1 = (((G__36207 == null))?null:G__36207.prototype);
if((G__36207__$1 == null)){
return null;
} else {
return G__36207__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36213 = c;
var G__36213__$1 = (((G__36213 == null))?null:G__36213.prototype);
if((G__36213__$1 == null)){
return null;
} else {
return G__36213__$1.render;
}
})() == null)))));
});
...
var G__36223 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36223) : reagent.impl.component.as_element.call(null,G__36223));
};
...
G__36462.cljs$lang$applyTo = (function (arglist__36465){
...
var _STAR_current_component_STAR__orig_val__36229 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36230 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36230);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36229);
}});
...
var c = this;
var G__36319_36478 = goog.object.get(c,"cljsRatom");
if((G__36319_36478 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36319_36478);
}
...
var renders_36481 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36482 = cljs.core.first(cljs.core.vals(renders_36481));
...
if((cljs.core.count(renders_36481) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36481))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36482)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36482], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36325 = o;
var G__36326_36486 = G__36325;
var G__36327_36487 = cljs.core.name(k);
var G__36328_36488 = v;
goog.object.set(G__36326_36486,G__36327_36487,G__36328_36488);
...
var G__36354_36489 = cmp.prototype;
var G__36355_36490 = module$node_modules$react$index.Component.prototype;
var G__36356_36491 = methods$;
goog.object.extend(G__36354_36489,G__36355_36490,G__36356_36491);
...
var name = (function (){var G__36380 = fiber;
var G__36380__$1 = (((G__36380 == null))?null:G__36380.type);
if((G__36380__$1 == null)){
return null;
} else {
return G__36380__$1.displayName;
}
})();
var parent = (function (){var G__36381 = fiber;
if((G__36381 == null)){
return null;
} else {
return G__36381.return;
}
})();
var path = (function (){var G__36382 = parent;
var G__36382__$1 = (((G__36382 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36382) : reagent.impl.component.fiber_component_path.call(null,G__36382)));
if((G__36382__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36382__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__36393 = c;
if((G__36393 == null)){
return null;
} else {
return goog.object.get(G__36393,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36395._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__36405 = c;
if((G__36405 == null)){
return null;
} else {
return goog.object.get(G__36405,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__36407 = c;
if((G__36407 == null)){
return null;
} else {
return G__36407._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__36414 = instance;
if((G__36414 == null)){
return null;
} else {
return goog.object.get(G__36414,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__36415 = instance;
if((G__36415 == null)){
return null;
} else {
return G__36415._currentElement;
}
}
})();
var name = (function (){var G__36416 = elem;
var G__36416__$1 = (((G__36416 == null))?null:G__36416.type);
if((G__36416__$1 == null)){
return null;
} else {
return G__36416__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__36422 = elem;
if((G__36422 == null)){
return null;
} else {
return goog.object.get(G__36422,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36423._owner;
}
}
})();
var path = (function (){var G__36425 = owner;
var G__36425__$1 = (((G__36425 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36425) : reagent.impl.component.component_path.call(null,G__36425)));
if((G__36425__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36425__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
